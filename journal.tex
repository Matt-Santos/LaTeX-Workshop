% !TEX program = latexmk
% !TEX options = -jobname=Journal_Example -synctex=1 -interaction=nonstopmode -shell-escape -pdflatex %DOC%
...
\documentclass[journal]{templates/IEEEtran}
...
\section{First Section}
	...
	\begin{figure}[!b] % optionally use [!t] pr [!h]
		\centering
		\includegraphics[width=2.5in,draft]{example-image-a}
...
\bibliography{bibliography/Books.bib}
\end{document}
