...
% Matthew Santos
% Generic Electrical Engineering Resume
...
%-------------HEADER-------------
\centerline{{\Huge\textbf{Matthew Santos}}}
\vspace{-2\baselineskip}
\href{https://matt-santos.github.io}{\faGithubSquare~matt-santos.github.io}\hfill
\href{mailto:matthewsantos@ieee.org}{\faEnvelope~matthewsantos@ieee.org}\\
\href{https://linkedin.com/in/matthewjsantos}{\faLinkedinSquare~in/matthewjsantos}\hfill
%\href{tel:XXXXXXXXXX}{\faPhone~(XXX) XXX-XXXX}
...
\resumeSkillEntry{Fredrick Atkins Graduate Scholarship}{University of Waterloo}{May 2019, 2020}
%\resumeSkillEntry{Best Capstone Project}{University of Windsor}{2018} EE Department
\resumeSkillEntry{Merit Scholarship}{University of Waterloo}{Sept. 2009}

% Interview Talking Points (Personal Notes)
%--------------------------------
% Nicolaus Copernicus - Heliocentric Model of the Solar System -> Copernicus Principle "We as humans are not special. Scientific theories should not be based on such an assumpution."
